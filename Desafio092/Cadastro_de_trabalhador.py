...
if ctps['carteira'] != 0:
        ...
        ctps['aposentadoria'] = (ctps['contratação'] + 35) - an  #O ano para aposentadoria é  a soma do ano que ela começou a trabalhar + a quantidade de tempo de trabalho menos o ano de nascimento.
print('-='*30)
for k, v in ctps.items():
        print(f'   - {k} tem o valor de {v}')

#tempo de trabalho necessário: 35 anos